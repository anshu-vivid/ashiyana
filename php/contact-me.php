...
if($_POST) {
    ...
    $to_Email = 'sales@ashiyanavillas.com'; // Write your email here to receive the form submissions
    $subject = 'New message from Ahiyana Villas'; // Write the subject you'll see in your inbox
