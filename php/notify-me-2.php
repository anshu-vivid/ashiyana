<?php
	...
	$email_to = "sales@ashiyanavillas.com"; // Write your email here to receive the email addresses submitted
    $subject = 'New subscriber from Ashiyana Villas'; // Write the subject you'll see in your inbox
